...
exclude_files = [ZIP_NAME, 'build.py', '.prettierrc', 'README.md', 'icon.psd']

def zip_directory(directory_path, zip_path, exclude_files):
...
if __name__ == "__main__":
    ...
    zip_directory(script_dir, zip_file_path, exclude_files)